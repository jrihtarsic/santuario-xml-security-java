...
public final class SelfSignedCertGenerator {
    ...
    static {
        ...
        // id-ml-dsa-44  2.16.840.1.101.3.4.3.17  (RFC 9881)
        m.put("ML-DSA-44",       hex("300b0609608648016503040311"));
        // id-ml-dsa-65  2.16.840.1.101.3.4.3.18
        m.put("ML-DSA-65",       hex("300b0609608648016503040312"));
        // id-ml-dsa-87  2.16.840.1.101.3.4.3.19
        m.put("ML-DSA-87",       hex("300b0609608648016503040313"));
