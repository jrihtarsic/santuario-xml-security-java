...
class HKDFTest {
    ...
    void deriveKey(String name, String hash, String ikm, String salt, String info, int length, String prk, String okm) throws XMLSecurityException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        HKDF hkdf = new HKDF(hash, saltBytes);
