...
public class SignatureAlgorithm extends Algorithm {
    ...
    public static void registerDefaultAlgorithms() {
        ...
        algorithmHash.put(
                XMLSignature.ALGO_ID_SIGNATURE_ML_DSA_44, SignatureMLDSA.SignatureMLDSA44.class
        );
        algorithmHash.put(
                XMLSignature.ALGO_ID_SIGNATURE_ML_DSA_65, SignatureMLDSA.SignatureMLDSA65.class
        );
        algorithmHash.put(
                XMLSignature.ALGO_ID_SIGNATURE_ML_DSA_87, SignatureMLDSA.SignatureMLDSA87.class
        );
        algorithmHash.put(
